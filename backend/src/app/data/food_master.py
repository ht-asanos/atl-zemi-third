...
STAPLE_SHORT_NAMES: dict[str, str] = {
    "冷凍うどん": "うどん",
    "白米": "ご飯",
    "オートミール": "オートミール",
    "パスタ": "パスタ",
...
# 主食短縮名 → 付け合わせ判定キーワード
# キーは STAPLE_SHORT_NAMES の値と完全一致させること。
# 「だし」は一般的な料理名（だし巻き卵等）との誤除外リスクが高いため除外。
# 「オートミール」は付け合わせパターンが現状見当たらないためエントリなし。
ACCOMPANIMENT_SUFFIXES: dict[str, list[str]] = {
    "うどん": ["つけ汁", "つけだれ", "つゆ", "かえし"],
    "パスタ": ["ソース", "たれ"],
    "ご飯": ["ふりかけ", "つくだ煮", "佃煮"],
    "パン": ["ジャム", "スプレッド", "ディップ"],
